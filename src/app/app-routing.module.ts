...
const routes: Routes = [
    ...
    {path:'mss/:id', component: MsToolsComponent},
                        ...
                        {path:'overview', component: WikiOverviewComponent},
                        {path:'glossary', component: WikiGlossaryComponent},
                         {path:'references', component: ReferencesComponent},
                        {path:'search', component: SearchWrapperComponent, canActivate:[AuthGuard]},
                         {path:'mss-list', component: MssListComponent},
                         {path:'texts-list', component: TextsListComponent, canActivate:[AuthGuard]},
                        ...
                        {path:'network/:fnc/:ids/:lits', component: NetworkComponent, canActivate:[AuthGuard]},
                        ...
                        {path:'constraints', component: LitConstraintsComponent,
